 ...
 */
public class TransparentActivityWork extends Activity implements BillingProcessor.IBillingHandler {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bp = new BillingProcessor(TransparentActivityWork.this, ConstsCore.base64EncodedPublicKey, this);
    ...
    private void alertRequestSend(final String from) {
        ...
        alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(TransparentActivityWork.this, RequestantActivity.class);
    ...
    private void alertRequestApproved(final String from) {
        ...
        alertDialogBuilder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                Intent i = new Intent(TransparentActivityWork.this, HistoryActivity.class);
                i.putExtra("GCFBID", GCFBID);
                i.putExtra("from", from);
                startActivity(i);
                finish();
