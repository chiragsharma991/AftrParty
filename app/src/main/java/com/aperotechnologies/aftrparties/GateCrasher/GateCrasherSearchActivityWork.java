 ...
 */
public class GateCrasherSearchActivityWork extends Activity {
    ...
    private IabHelper mPPurchaseHelper;
...
//        spn_byob.setAdapter(byob);
        ...
        btninapppurchase.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                /****/
                mPPurchaseHelper = new IabHelper(GateCrasherSearchActivityWork.this, ConstsCore.base64EncodedPublicKey);

                mPPurchaseHelper.startSetup(new IabHelper.OnIabSetupFinishedListener() {
                    public void onIabSetupFinished(IabResult result) {
                        if (!result.isSuccess()) {
                            Log.e("GateCrasherSearchActivity", "In-app Billing setup failed: " +
                                    result);
                        } else {
                            Log.e("GateCrasherSearchActivity", "In-app Billing is set up OK");
                        }
                    }
                });
                /****/
                ...
                try {
                    ...
                    if (paidgclist == null || paidgclist.size() == 0) {
                        ...
                        AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(GateCrasherSearchActivityWork.this);
                        alertDialogBuilder
                                ...
                                .setPositiveButton("Yes",
                                        new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int id) {
                                                ...
                                                try {
                                                    mPPurchaseHelper.launchPurchaseFlow(GateCrasherSearchActivityWork.this, ConstsCore.ITEM_PARTYPURCHASE_SKU, ConstsCore.RequestCode,
                    ...
                    else
                    {
                        ...
                        {
                            GenerikFunctions.showToast(cont, " paidgclist Yes");
...
//
        ...
        btn_getCurrentLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    if (ActivityCompat.checkSelfPermission(GateCrasherSearchActivityWork.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED
                            &&
                            ActivityCompat.checkSelfPermission(GateCrasherSearchActivityWork.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
...
//                }
    ...
    public void getSelfLocation() {
        ...
        if (!locationManager.isProviderEnabled(LocationManager.GPS_PROVIDER)) {
            Toast.makeText(GateCrasherSearchActivityWork.this, "GPS not Available", Toast.LENGTH_LONG).show();
        ...
        switch (requestCode)
        {
            case MY_PERMISSIONS_ACCESS_CF_LOCATION:
            {
                ...
                else
                {
                    ...
                    if (ActivityCompat.shouldShowRequestPermissionRationale(GateCrasherSearchActivityWork.this, Manifest.permission.ACCESS_FINE_LOCATION))
                    {
                        //showStoragePermissionRationale();

                        new AlertDialog.Builder(GateCrasherSearchActivityWork.this)
                                ...
                                .setPositiveButton("Retry", new DialogInterface.OnClickListener()
                                {
                                    public void onClick(DialogInterface dialog, int which)
                                    {
                                        ...
                                        ActivityCompat.requestPermissions(GateCrasherSearchActivityWork.this,
...
//        return d.getTime();
    ...
    private DatePicker startDateDialog(String check) {
        ...
        DatePickerDialog dp = new DatePickerDialog(GateCrasherSearchActivityWork.this,new DatePickerDialog.OnDateSetListener() {
...
//            if (mPPurchaseHelper == null) return;
//
    ...
    private void consumeItem() {
        try {
            mPPurchaseHelper.queryInventoryAsync(mReceivedInventoryListener);
        ...
        public void onQueryInventoryFinished(IabResult result, Inventory inv) {
            if (result.isFailure()) {
                ...
                try {
                    ...
                    mPPurchaseHelper.consumeAsync(inv.getPurchase(ConstsCore.ITEM_PARTYPURCHASE_SKU),
